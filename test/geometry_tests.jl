...
function print_pmesh_coordinates(
    pmesh::GT.PMesh, parts, face_id::Int, face_dim::Int, part_id::Int = 0)
...
mesh = GT.cartesian_mesh(domain,cells)
GT.mesh_graph(mesh;partition_strategy=GT.partition_strategy(graph_nodes=:nodes,graph_edges=:cells))
GT.mesh_graph(mesh;partition_strategy=GT.partition_strategy(graph_nodes=:nodes,graph_edges=:faces,graph_edges_dim=:all))
GT.mesh_graph(mesh;partition_strategy=GT.partition_strategy(graph_nodes=:nodes,graph_edges=:faces,graph_edges_dim=1))
GT.mesh_graph(mesh;partition_strategy=GT.partition_strategy(graph_nodes=:cells,graph_edges=:nodes))
GT.mesh_graph(mesh;partition_strategy=GT.partition_strategy(graph_nodes=:cells,graph_edges=:faces,graph_edges_dim=1))
...
cells_per_dir = (4,4)
parts_per_dir = (2,2)
pmesh = GT.cartesian_mesh(domain,cells_per_dir;parts_per_dir,partition_strategy=GT.partition_strategy(graph_nodes=:cells,graph_edges=:nodes,ghost_layers=1))
pmesh = GT.cartesian_mesh(domain,cells_per_dir;parts_per_dir,partition_strategy=GT.partition_strategy(graph_nodes=:cells,graph_edges=:nodes,ghost_layers=0))
np = prod(parts_per_dir)
parts = DebugArray(LinearIndices((np,)))
pmesh = GT.cartesian_mesh(domain,cells_per_dir;parts_per_dir,parts,partition_strategy=GT.partition_strategy(graph_nodes=:cells,graph_edges=:nodes,ghost_layers=1))
pmesh = GT.cartesian_mesh(domain,cells_per_dir;parts_per_dir,parts,partition_strategy=GT.partition_strategy(graph_nodes=:cells,graph_edges=:nodes,ghost_layers=0))
